sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/infocus/app/fi/zTaxApprove/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#TaxProofSubmission-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#TaxProofSubmission-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.infocus.app.fi.zTaxApprove.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/infocus/app/fi/zTaxApprove/localService/mockserver"], function (mockserver) {
